...
# Load the .mat file
mat_file = r'd:\Users\mabida\Downloads\GenAI-Models-for-Channel-Data-Augmentation-main\data\HMIMO_6GHz_Cellfree_Pass5B_8AP1.mat'
...
with h5py.File(mat_file, 'r') as f:
    ...
    df.to_csv('data\hmimo_Passage5B_complex.csv', index=False)
