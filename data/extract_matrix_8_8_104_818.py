...
def generate_indices(start_index=0, n=8):
...
raw_selected_2 = data[:, indices_2, :, :, 0]  # (818, 8, 52, 8)
...
combined_matrix = np.concatenate([selected_1, selected_2], axis=2)  # (8, 8, 104, 818)

#########################################################################
# Sauvegarde
output_dir = 'matrix2_8_8_104_818'
os.makedirs(output_dir, exist_ok=True)

output_path = os.path.join(output_dir, 'matrix_8_8_104_818.npy')
